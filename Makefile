...
GO_STATIC_PACKAGES = $(PROJECT_REPO)/cmd/provider
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider ZoneHero CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider ZoneHero controllers
...
# This target prepares repo for your provider by replacing all "zonehero"
