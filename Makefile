...
export TERRAFORM_PROVIDER_SOURCE ?= OrographicLift/hlb
export TERRAFORM_PROVIDER_REPO ?= https://github.com/OrographicLift/terraform-provider-hlb
export TERRAFORM_PROVIDER_VERSION ?= 1.2.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-hlb
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-hlb_v1.2.0
