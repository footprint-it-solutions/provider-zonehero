...
The [provider-zonehero](https://github.com/footprint-it-solutions/provider-zonehero) repository can be
used as a starting point for new providers. For [terrajet](https://github.com/crossplane/terrajet)-based providers, the
[provider-jet-zonehero](https://github.com/crossplane-contrib/provider-jet-zonehero) is
available.
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/footprint-it-solutions/provider-zonehero/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/footprint-it-solutions/provider-zonehero/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/footprint-it-solutions/provider-zonehero/blob/main/hack/boilerplate.go.txt](https://github.com/footprint-it-solutions/provider-zonehero/blob/main/hack/boilerplate.go.txt)
...
The [provider-zonehero](https://github.com/footprint-it-solutions/provider-zonehero)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/footprint-it-solutions/provider-zonehero/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/footprint-it-solutions/provider-zonehero/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue zoneheros (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/footprint-it-solutions/provider-zonehero/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request ZoneHeros: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/footprint-it-solutions/provider-zonehero/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
